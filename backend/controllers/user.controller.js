...
export const followUnfollowUser = async (req, res) => {
    try {
        ...
        if(isfollowing){
            ...
            // send notification
            const newNotification = new Notication({
                type: "follow",
                from: req.user._id,
                to: userToModify._id,
            })
...
export const getSuggestedUsers = async (req, res) => {
    try {
        ...
        const usersFllowByMe = await User.findById(userId).select("following");
        ...
        //
        const filteredUsers= users.filter((user) => !usersFllowByMe.following.includes(user._id));
